...
public class RcyConfigListAdapter extends RecyclerView.Adapter<RcyConfigListAdapter.ConfigureHolder> {
    ...
    public RcyConfigListAdapter(Context context, List<ConfigListBean.DataBean.RecordsBean> list) {
